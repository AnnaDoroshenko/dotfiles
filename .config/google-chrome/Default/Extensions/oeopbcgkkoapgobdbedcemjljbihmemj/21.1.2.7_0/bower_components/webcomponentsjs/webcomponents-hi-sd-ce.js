...
'use strict';(function() {
      ...
      if (!url) {
        ...
        if (url.match(/^data:/)) {
          ...
          request.onload = function() {
            var redirectedUrl = request.getResponseHeader("Location"); // jason: removed request.responseURL
  ...
  function patchAccessorGroup(obj, descriptors, force) {
    for (var p$3 in descriptors) {
      var objDesc = Object.getOwnPropertyDescriptor(obj, p$3);
      if (objDesc && objDesc.configurable || !objDesc && force) {
        Object.defineProperty(obj, p$3, descriptors[p$3]);
      } else {
        if (force) {
          console.warn("Could not define", p$3, "on", obj);
        }
      }
    }
  }
  ...
  function insertBefore$1(parent, node, ref_node) {
    ...
    if (ref_node) {
      var p$4 = ref_node.__shady && ref_node.__shady.parentNode;
      if (p$4 !== undefined && p$4 !== parent || p$4 === undefined && parentNode(ref_node) !== parent) {
  ...
  function retargetNonBubblingEvent(e) {
    ...
    var lastFiredRoot;
    for (var i$5 = 0;i$5 < path.length;i$5++) {
      node = path[i$5];
      var root = node.__shady && node.__shady.root;
      if (i$5 === 0 || root && root === lastFiredRoot) {
  ...
  function removeEventListener$1(type, fnOrObj, optionsOrCapture) {
    ...
    if (wrapperFn && nonBubblingEventsToRetarget[type] && this.__handlers && this.__handlers[type]) {
      ...
      var idx$6 = arr.indexOf(wrapperFn);
      if (idx$6 > -1) {
        arr.splice(idx$6, 1);
      }
    }
  ...
  function calcEditDistances(current, currentStart, currentEnd, old, oldStart, oldEnd) {
    ...
    for (var i$7 = 1;i$7 < rowCount;i$7++) {
      for (var j$8 = 1;j$8 < columnCount;j$8++) {
        if (equals(current[currentStart + j$8 - 1], old[oldStart + i$7 - 1])) {
          distances[i$7][j$8] = distances[i$7 - 1][j$8 - 1];
        } else {
          var north = distances[i$7 - 1][j$8] + 1;
          var west = distances[i$7][j$8 - 1] + 1;
          distances[i$7][j$8] = north < west ? north : west;
        }
      }
    }
    return distances;
  ...
  ShadyRoot.prototype._distribute = function() {
    ...
    for (var i$9 = 0, slot;i$9 < this._slotList.length;i$9++) {
      slot = this._slotList[i$9];
      if (!slot.__shady.assignedNodes.length) {
        for (var n$10 = slot.firstChild;n$10;n$10 = n$10.nextSibling) {
          this._distributeNodeToSlot(n$10, slot);
        }
      }
      ...
      if (prevAssignedNodes) {
        for (var i$11 = 0;i$11 < prevAssignedNodes.length;i$11++) {
          prevAssignedNodes[i$11].__shady._prevAssignedSlot = null;
        }
  ...
  ShadyRoot.prototype._compose = function() {
    ...
    for (var i$12 = 0;i$12 < composeList.length;i$12++) {
      var node = composeList[i$12];
  ...
  ShadyRoot.prototype._updateChildNodes = function(container, children$$1) {
    ...
    for (var i$13 = 0, s, next;i$13 < splices.length && (s = splices[i$13]);i$13++) {
      next = composed[s.index];
      for (var j$14 = s.index, n;j$14 < s.index + s.addedCount;j$14++) {
        n = children$$1[j$14];
        insertBefore.call(container, n, next);
        composed.splice(j$14, 0, n);
      }
    }
  };
    ...
    while (node) {
      if (node.nodeType === Node.ELEMENT_NODE) {
        ...
        if (localName === "link" && element.getAttribute("rel") === "import") {
          var importNode$15 = (element.import);
          if (importNode$15 instanceof Node && !visitedImports.has(importNode$15)) {
            visitedImports.add(importNode$15);
            for (var child = importNode$15.firstChild;child;child = child.nextSibling) {
        ...
        if (shadowRoot) {
          for (var child$16 = shadowRoot.firstChild;child$16;child$16 = child$16.nextSibling) {
            walkDeepDescendantElements(child$16, callback, visitedImports);
          }
        }
      }
  ...
  CustomElementInternals.prototype.patchAndUpgradeTree = function(root, visitedImports) {
    ...
    var gatherElements = function(element) {
      if (element.localName === "link" && element.getAttribute("rel") === "import") {
        var importNode$17 = (element.import);
        if (importNode$17 instanceof Node && importNode$17.readyState === "complete") {
          importNode$17.__CE_isImportDocument = true;
          importNode$17.__CE_hasRegistry = true;
        } else {
    ...
    for (var i$18 = 0;i$18 < elements.length;i$18++) {
      this.upgradeElement(elements[i$18]);
    }
  };
    ...
    window["HTMLElement"] = function() {
      function HTMLElement() {
        ...
        if (constructionStack.length === 0) {
          var element$19 = Native.Document_createElement.call(document, definition.localName);
          Object.setPrototypeOf(element$19, constructor.prototype);
          element$19.__CE_state = CustomElementState.custom;
          element$19.__CE_definition = definition;
          internals.patch(element$19);
          return element$19;
        }
  ...
  var PatchParentNode = function(internals, destination, builtIn) {
    destination["prepend"] = function(nodes) {
      ...
      {
        var nodes$20 = $jscomp$restParams;
        var connectedBefore = (nodes$20.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.prepend.apply(this, nodes$20);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$21 = 0;i$21 < nodes$20.length;i$21++) {
            var node = nodes$20[i$21];
    ...
    destination["append"] = function(nodes) {
      ...
      {
        var nodes$22 = $jscomp$restParams;
        var connectedBefore = (nodes$22.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.append.apply(this, nodes$22);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$23 = 0;i$23 < nodes$22.length;i$23++) {
            var node = nodes$22[i$23];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
  ...
  var PatchNode = function(internals) {
    setPropertyUnchecked(Node.prototype, "insertBefore", function(node, refNode) {
      if (node instanceof DocumentFragment) {
        ...
        var nativeResult$24 = Native.Node_insertBefore.call(this, node, refNode);
        if (isConnected(this)) {
    ...
    setPropertyUnchecked(Node.prototype, "appendChild", function(node) {
      if (node instanceof DocumentFragment) {
        var insertedNodes = Array.prototype.slice.apply(node.childNodes);
        var nativeResult$25 = Native.Node_appendChild.call(this, node);
        if (isConnected(this)) {
          for (var i = 0;i < insertedNodes.length;i++) {
            internals.connectTree(insertedNodes[i]);
          }
    ...
    setPropertyUnchecked(Node.prototype, "replaceChild", function(nodeToInsert, nodeToRemove) {
      if (nodeToInsert instanceof DocumentFragment) {
        ...
        var nativeResult$26 = Native.Node_replaceChild.call(this, nodeToInsert, nodeToRemove);
        if (isConnected(this)) {
    ...
    function patch_textContent(destination, baseDescriptor) {
      Object.defineProperty(destination, "textContent", {enumerable:baseDescriptor.enumerable, configurable:true, get:baseDescriptor.get, set:function(assignedValue) {
        ...
        if (this.firstChild) {
          var childNodes$27 = this.childNodes;
          var childNodesLength = childNodes$27.length;
          if (childNodesLength > 0 && isConnected(this)) {
            removedNodes = new Array(childNodesLength);
            for (var i = 0;i < childNodesLength;i++) {
              removedNodes[i] = childNodes$27[i];
            }
          }
        }
        baseDescriptor.set.call(this, assignedValue);
        if (removedNodes) {
          for (var i$28 = 0;i$28 < removedNodes.length;i$28++) {
            internals.disconnectTree(removedNodes[i$28]);
          }
        }
      }});
    }
  ...
  var PatchChildNode = function(internals, destination, builtIn) {
    destination["before"] = function(nodes) {
      ...
      }
      {
        ...
        builtIn.before.apply(this, nodes$29);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
    ...
    destination["after"] = function(nodes) {
      ...
      }
      {
        ...
        builtIn.after.apply(this, nodes$31);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
    ...
    destination["replaceWith"] = function(nodes) {
      ...
      {
        var nodes$33 = $jscomp$restParams;
        var connectedBefore = (nodes$33.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        var wasConnected = isConnected(this);
        builtIn.replaceWith.apply(this, nodes$33);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (wasConnected) {
          internals.disconnectTree(this);
          for (var i$34 = 0;i$34 < nodes$33.length;i$34++) {
            var node = nodes$33[i$34];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
  ...
  function lex(text) {
    ...
    for (var i = 0, l = text.length;i < l;i++) {
      if (text[i] === OPEN_BRACE) {
        ...
        var p$35 = n;
        var previous = p$35["rules"][p$35["rules"].length - 1] || null;
        n = new StyleNode;
        n["start"] = i + 1;
        n["parent"] = p$35;
        n["previous"] = previous;
      ...
      if (element.classList) {
        ...
        if (element.getAttribute) {
          ...
          if (shouldRemoveScope) {
            ...
            var newValue$36 = (c ? c + " " : "") + SCOPE_NAME + " " + scope;
            setElementClassRaw(element, newValue$36);
          }
        }
      }
    }
  ...
  function updateNativeProperties(element, properties) {
    for (var p$37 in properties) {
      if (p$37 === null) {
        element.style.removeProperty(p$37);
      } else {
        element.style.setProperty(p$37, properties[p$37]);
      }
    }
  }
  ...
  ScopingShim.prototype._mixinOverrideStyles = function(props, overrides) {
    for (var p$38 in overrides) {
      var v = overrides[p$38];
      if (v || v === 0) {
        props[p$38] = v;
      }
    }
  ...
  ScopingShim.prototype.styleSubtree = function(host, properties) {
    ...
    if (shadowChildren) {
      ...
      var children$39 = host.children || host.childNodes;
      if (children$39) {
        for (var i$40 = 0;i$40 < children$39.length;i$40++) {
          var c$41 = (children$39[i$40]);
          this.styleSubtree(c$41);
        }
      }
    }
  };
