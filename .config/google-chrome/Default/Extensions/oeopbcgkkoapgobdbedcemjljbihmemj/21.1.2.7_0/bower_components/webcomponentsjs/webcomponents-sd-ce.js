...
'use strict';(function() {
  ...
  function extendAll(target, sources) {
    ...
    {
      var sources$0 = $jscomp$restParams;
      for (var i = 0;i < sources$0.length;i++) {
        extend(target, sources$0[i]);
      }
      return target;
    }
  }
  ...
  function patchAccessorGroup(obj, descriptors, force) {
    for (var p$2 in descriptors) {
      var objDesc = Object.getOwnPropertyDescriptor(obj, p$2);
      if (objDesc && objDesc.configurable || !objDesc && force) {
        Object.defineProperty(obj, p$2, descriptors[p$2]);
      } else {
        if (force) {
          console.warn("Could not define", p$2, "on", obj);
        }
      }
    }
  }
  ...
  function insertBefore$1(parent, node, ref_node) {
    ...
    if (ref_node) {
      var p$3 = ref_node.__shady && ref_node.__shady.parentNode;
      if (p$3 !== undefined && p$3 !== parent || p$3 === undefined && parentNode(ref_node) !== parent) {
  ...
  function retargetNonBubblingEvent(e) {
    ...
    var lastFiredRoot;
    for (var i$4 = 0;i$4 < path.length;i$4++) {
      node = path[i$4];
      var root = node.__shady && node.__shady.root;
      if (i$4 === 0 || root && root === lastFiredRoot) {
  ...
  function removeEventListener$1(type, fnOrObj, optionsOrCapture) {
    ...
    if (wrapperFn && nonBubblingEventsToRetarget[type] && this.__handlers && this.__handlers[type]) {
      ...
      var idx$5 = arr.indexOf(wrapperFn);
      if (idx$5 > -1) {
        arr.splice(idx$5, 1);
      }
    }
  ...
  function calcEditDistances(current, currentStart, currentEnd, old, oldStart, oldEnd) {
    ...
    for (var i$6 = 1;i$6 < rowCount;i$6++) {
      for (var j$7 = 1;j$7 < columnCount;j$7++) {
        if (equals(current[currentStart + j$7 - 1], old[oldStart + i$6 - 1])) {
          distances[i$6][j$7] = distances[i$6 - 1][j$7 - 1];
        } else {
          var north = distances[i$6 - 1][j$7] + 1;
          var west = distances[i$6][j$7 - 1] + 1;
          distances[i$6][j$7] = north < west ? north : west;
        }
      }
    }
    return distances;
  ...
  ShadyRoot.prototype._distribute = function() {
    ...
    for (var i$8 = 0, slot;i$8 < this._slotList.length;i$8++) {
      slot = this._slotList[i$8];
      if (!slot.__shady.assignedNodes.length) {
        for (var n$9 = slot.firstChild;n$9;n$9 = n$9.nextSibling) {
          this._distributeNodeToSlot(n$9, slot);
        }
      }
      ...
      if (prevAssignedNodes) {
        for (var i$10 = 0;i$10 < prevAssignedNodes.length;i$10++) {
          prevAssignedNodes[i$10].__shady._prevAssignedSlot = null;
        }
  ...
  ShadyRoot.prototype._compose = function() {
    ...
    for (var i$11 = 0;i$11 < composeList.length;i$11++) {
      var node = composeList[i$11];
  ...
  ShadyRoot.prototype._updateChildNodes = function(container, children$$1) {
    ...
    for (var i$12 = 0, s, next;i$12 < splices.length && (s = splices[i$12]);i$12++) {
      next = composed[s.index];
      for (var j$13 = s.index, n;j$13 < s.index + s.addedCount;j$13++) {
        n = children$$1[j$13];
        insertBefore.call(container, n, next);
        composed.splice(j$13, 0, n);
      }
    }
  };
    ...
    while (node) {
      if (node.nodeType === Node.ELEMENT_NODE) {
        ...
        if (localName === "link" && element.getAttribute("rel") === "import") {
          var importNode$14 = (element.import);
          if (importNode$14 instanceof Node && !visitedImports.has(importNode$14)) {
            visitedImports.add(importNode$14);
            for (var child = importNode$14.firstChild;child;child = child.nextSibling) {
        ...
        if (shadowRoot) {
          for (var child$15 = shadowRoot.firstChild;child$15;child$15 = child$15.nextSibling) {
            walkDeepDescendantElements(child$15, callback, visitedImports);
          }
        }
      }
  ...
  CustomElementInternals.prototype.patchAndUpgradeTree = function(root, visitedImports) {
    ...
    var gatherElements = function(element) {
      if (element.localName === "link" && element.getAttribute("rel") === "import") {
        var importNode$16 = (element.import);
        if (importNode$16 instanceof Node && importNode$16.readyState === "complete") {
          importNode$16.__CE_isImportDocument = true;
          importNode$16.__CE_hasRegistry = true;
        } else {
    ...
    for (var i$17 = 0;i$17 < elements.length;i$17++) {
      this.upgradeElement(elements[i$17]);
    }
  };
    ...
    window["HTMLElement"] = function() {
      function HTMLElement() {
        ...
        if (constructionStack.length === 0) {
          var element$18 = Native.Document_createElement.call(document, definition.localName);
          Object.setPrototypeOf(element$18, constructor.prototype);
          element$18.__CE_state = CustomElementState.custom;
          element$18.__CE_definition = definition;
          internals.patch(element$18);
          return element$18;
        }
  ...
  var PatchParentNode = function(internals, destination, builtIn) {
    destination["prepend"] = function(nodes) {
      ...
      {
        var nodes$19 = $jscomp$restParams;
        var connectedBefore = (nodes$19.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.prepend.apply(this, nodes$19);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$20 = 0;i$20 < nodes$19.length;i$20++) {
            var node = nodes$19[i$20];
    ...
    destination["append"] = function(nodes) {
      ...
      {
        var nodes$21 = $jscomp$restParams;
        var connectedBefore = (nodes$21.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.append.apply(this, nodes$21);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$22 = 0;i$22 < nodes$21.length;i$22++) {
            var node = nodes$21[i$22];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
  ...
  var PatchNode = function(internals) {
    setPropertyUnchecked(Node.prototype, "insertBefore", function(node, refNode) {
      if (node instanceof DocumentFragment) {
        ...
        var nativeResult$23 = Native.Node_insertBefore.call(this, node, refNode);
        if (isConnected(this)) {
    ...
    setPropertyUnchecked(Node.prototype, "appendChild", function(node) {
      if (node instanceof DocumentFragment) {
        var insertedNodes = Array.prototype.slice.apply(node.childNodes);
        var nativeResult$24 = Native.Node_appendChild.call(this, node);
        if (isConnected(this)) {
          for (var i = 0;i < insertedNodes.length;i++) {
            internals.connectTree(insertedNodes[i]);
          }
    ...
    setPropertyUnchecked(Node.prototype, "replaceChild", function(nodeToInsert, nodeToRemove) {
      if (nodeToInsert instanceof DocumentFragment) {
        ...
        var nativeResult$25 = Native.Node_replaceChild.call(this, nodeToInsert, nodeToRemove);
        if (isConnected(this)) {
    ...
    function patch_textContent(destination, baseDescriptor) {
      Object.defineProperty(destination, "textContent", {enumerable:baseDescriptor.enumerable, configurable:true, get:baseDescriptor.get, set:function(assignedValue) {
        ...
        if (this.firstChild) {
          var childNodes$26 = this.childNodes;
          var childNodesLength = childNodes$26.length;
          if (childNodesLength > 0 && isConnected(this)) {
            removedNodes = new Array(childNodesLength);
            for (var i = 0;i < childNodesLength;i++) {
              removedNodes[i] = childNodes$26[i];
            }
          }
        }
        baseDescriptor.set.call(this, assignedValue);
        if (removedNodes) {
          for (var i$27 = 0;i$27 < removedNodes.length;i$27++) {
            internals.disconnectTree(removedNodes[i$27]);
          }
        }
      }});
    }
  ...
  var PatchChildNode = function(internals, destination, builtIn) {
    destination["before"] = function(nodes) {
      ...
      {
        var nodes$28 = $jscomp$restParams;
        var connectedBefore = (nodes$28.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.before.apply(this, nodes$28);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$29 = 0;i$29 < nodes$28.length;i$29++) {
            var node = nodes$28[i$29];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
    ...
    destination["after"] = function(nodes) {
      ...
      {
        var nodes$30 = $jscomp$restParams;
        var connectedBefore = (nodes$30.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        builtIn.after.apply(this, nodes$30);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (isConnected(this)) {
          for (var i$31 = 0;i$31 < nodes$30.length;i$31++) {
            var node = nodes$30[i$31];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
    ...
    destination["replaceWith"] = function(nodes) {
      ...
      {
        var nodes$32 = $jscomp$restParams;
        var connectedBefore = (nodes$32.filter(function(node) {
          return node instanceof Node && isConnected(node);
        }));
        var wasConnected = isConnected(this);
        builtIn.replaceWith.apply(this, nodes$32);
        for (var i = 0;i < connectedBefore.length;i++) {
          internals.disconnectTree(connectedBefore[i]);
        }
        if (wasConnected) {
          internals.disconnectTree(this);
          for (var i$33 = 0;i$33 < nodes$32.length;i$33++) {
            var node = nodes$32[i$33];
            if (node instanceof Element) {
              internals.connectTree(node);
            }
          }
  ...
  function lex(text) {
    ...
    for (var i = 0, l = text.length;i < l;i++) {
      if (text[i] === OPEN_BRACE) {
        ...
        var p$34 = n;
        var previous = p$34["rules"][p$34["rules"].length - 1] || null;
        n = new StyleNode;
        n["start"] = i + 1;
        n["parent"] = p$34;
        n["previous"] = previous;
      ...
      if (element.classList) {
        ...
        if (element.getAttribute) {
          ...
          if (shouldRemoveScope) {
            ...
            var newValue$35 = (c ? c + " " : "") + SCOPE_NAME + " " + scope;
            setElementClassRaw(element, newValue$35);
          }
        }
      }
    }
  ...
  function updateNativeProperties(element, properties) {
    for (var p$36 in properties) {
      if (p$36 === null) {
        element.style.removeProperty(p$36);
      } else {
        element.style.setProperty(p$36, properties[p$36]);
      }
    }
  }
  ...
  ScopingShim.prototype._mixinOverrideStyles = function(props, overrides) {
    for (var p$37 in overrides) {
      var v = overrides[p$37];
      if (v || v === 0) {
        props[p$37] = v;
      }
    }
  ...
  ScopingShim.prototype.styleSubtree = function(host, properties) {
    ...
    if (shadowChildren) {
      ...
      var children$38 = host.children || host.childNodes;
      if (children$38) {
        for (var i$39 = 0;i$39 < children$38.length;i$39++) {
          var c$40 = (children$38[i$39]);
          this.styleSubtree(c$40);
        }
      }
    }
  };
