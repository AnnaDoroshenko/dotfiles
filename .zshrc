...
alias mntc='sudo mount -o uid=anka,gid=users,fmask=111,dmask=000'
alias umntc='sudo umount'

alias vim='nvim'
alias svim='sudo -E nvim'

alias deu='cd ~/data/Deutsch'
...
export ZSH=/home/anka/.oh-my-zsh

# Set name of the theme to load. Optionally, if you set this to "random"
# it'll load a random theme each time that oh-my-zsh is loaded.
# See https://github.com/robbyrussell/oh-my-zsh/wiki/Themes
# If there is WARNING: Your terminal supports less than 256 colors!
# Should be added before the theme is called!
export TERM="xterm-256color"
# To use the additional glyphs add MODE before specifying the theme!
